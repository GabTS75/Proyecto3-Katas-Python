...
#     2. Implementar el método crecer_tronco para aumentar la longitud del tronco en
#        una unidad.
#     3. Implementar el método nueva_rama para agregar una nueva rama de longitud 1 a
#        la lista de ramas.
#     4. Implementar el método crecer_ramas para aumentar en una unidad la longitud de
#        todas las ramas existentes.
#     5. Implementar el método quitar_rama para eliminar una rama en una posición
#        específica.
#     6. Implementar el método info_arbol para devolver información sobre la longitud
